...
public enum AuthorizationSidecarCodec {
    ...
    public static let legacyReservedFieldName =
    ...
    public static func extract(
        ...
        let legacySidecarValue = object.removeValue(
            forKey: legacyReservedFieldName)
        ...
        if legacySidecarValue != nil {
            return invalidSidecar(
                .malformed(.unexpectedField(legacyReservedFieldName)),
    ...
    public static func containsReservedField(
        ...
        return object[reservedFieldName] != nil
            || object[legacyReservedFieldName] != nil
    }
    ...
    public static func prepare(
        ...
        if case .malformed(.unexpectedField(let field)) =
                extraction.sidecarStatus,
           field == legacyReservedFieldName {
            return PreparedPermissionToolCall(
                providerCall: providerCall,
                executableCall: nil,
                modelAuthorizationContext: nil,
    ...
    private static func decorateParameters(
        ...
        guard properties[reservedFieldName] == nil,
              properties[legacyReservedFieldName] == nil else {
            throw AuthorizationSidecarSchemaDecorationError
        ...
        guard !required.contains(.string(reservedFieldName)),
              !required.contains(.string(legacyReservedFieldName)) else {
            throw AuthorizationSidecarSchemaDecorationError
                .reservedFieldCollision(toolPath: toolPath)
        }
