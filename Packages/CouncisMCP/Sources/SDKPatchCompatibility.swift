...
/// Audited upstream identity for the only MCP SDK linked by Councis.
///
...
/// A feature whose SDK surface must be verified independently from Councis's
/// host behavior. `requiresAdapter` means the SDK primitive is usable only
/// behind a reviewed Councis lifecycle/policy adapter; `requiresPatch` means
...
public struct MCPSDKCompatibilityEntry: Codable, Equatable, Sendable {
    ...
    public let councisContract: String
    ...
    public init(
        ...
        self.councisContract = councisContract
...
public enum SDKPatchCompatibility {
    ...
    public static let entries: [MCPSDKCompatibilityEntry] = [
        ...
        MCPSDKCompatibilityEntry(
            ...
            councisContract:
                "Councis supplies the exact task wire surface, including discriminated CallTool/CreateSamplingMessage/CreateElicitation result unions whose task branch is the exact CreateTaskResult shape; separate remote-server and client-hosted state machines are advertised only for standard-extended after conformance.",
            conformanceTests: [
                "MCPTaskWireTests",
            ...
            upgradeReplay: [
                ...
                "Reconcile upstream wire types without weakening Councis durable state machines.",
        ...
        MCPSDKCompatibilityEntry(
            ...
            councisContract:
                "Councis owns executable identity, sandbox, environment, process group, bounded framing, stderr diagnostics, cancellation, and TERM/KILL drain.",
            conformanceTests: [
        ...
        MCPSDKCompatibilityEntry(
            ...
            councisContract:
                "Councis owns POST/GET/SSE/202/resume/session/404/DELETE, exact origin/trust/proxy/egress, body/frame caps, generation fencing, cancellation, and no replay of side-effecting requests.",
            conformanceTests: [
        ...
        MCPSDKCompatibilityEntry(
            ...
            councisContract:
                "Councis owns canonical resource/audience, scope step-up, callback generation, account/authority isolation, durable secret storage, DNS/origin policy, and explicit non-replaying challenge recovery.",
            conformanceTests: [
                "MCPOAuthTests",
        ...
        MCPSDKCompatibilityEntry(
            ...
            councisContract:
                "Councis pins its conformance runner and scenario inventory; unknown/unexecuted scenarios fail, and hostile fixtures complement official conformance.",
            conformanceTests: [
    ...
    /// capability shape used by both Councis protocol profiles.
