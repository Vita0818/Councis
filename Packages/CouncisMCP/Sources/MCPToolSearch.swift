...
// 61a44880a85d2fd0d8770908dea5733495e571c8. Councis adapts them to its Swift
...
public struct MCPDeferredFunctionSpec:
    ...
    public init(entry: MCPToolBindingEntry) {
        ...
        strict = false
        deferLoading = true
        // Codex strips output_schema from tool_search results. Councis keeps
...
public extension MCPToolRegistryBuilder {
    static func buildSearchable(
        ...
        let version = "councis.mcp.registry.search.v1." + stableHash([
