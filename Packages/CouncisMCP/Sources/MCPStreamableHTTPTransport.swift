...
/// Councis-owned implementation of MCP Streamable HTTP 2025-11-25.
///
    ...
    NegotiatedProtocolVersionTransport
{
    ...
    #if canImport(CouncisCurlTransport)
    ...
    init(
        ...
        queue.name = "councis.mcp.http.url-session"
