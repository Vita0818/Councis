# Councis rbook helper

This is the fixed, separately built EPUB backend for `CouncisTools`. It is not
...
- macOS: `~/Library/Application Support/Councis/document-runtime/bin/councis-rbook-helper`
- Linux: `~/.local/share/councis/document-runtime/bin/councis-rbook-helper`

Councis only reads that optional user-managed runtime. It does not install or
...
versioned request is supplied through the two host-owned `COUNCIS_DOCUMENT_*`
