...
enum DocumentPythonBackend {
    ...
    static func invocation(
        ...
        return DocumentBackendInvocation(
            ...
            environment: [
                "COUNCIS_DOCUMENT_REQUEST": encoded,
                "COUNCIS_DOCUMENT_OPERATION": operation,
                "PYTHONHASHSEED": "0",
            ],
    ...
    static func fixedOCRPayload(
        ...
        guard let runtime = councisDocumentRuntimeRoot() else {
...
def require_request():
    raw = os.environ.get('COUNCIS_DOCUMENT_REQUEST')
    ...
    if os.environ.get('COUNCIS_DOCUMENT_OPERATION') != value['operation']:
