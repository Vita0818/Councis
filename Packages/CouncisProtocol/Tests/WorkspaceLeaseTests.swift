import XCTest
import CouncisCore
@testable import CouncisProtocol
...
final class WorkspaceLeaseTests: XCTestCase {
    ...
    func testWorkspaceLeaseBindsExistingDirectoryIdentityAndDetectsReplacement() throws {
        let parent = FileManager.default.temporaryDirectory
            .appendingPathComponent("councis-lease-identity-\(UUID().uuidString)", isDirectory: true)
    ...
    func testWorkspaceLeaseExpressesRootAccessAndDeniedPatterns() {
        ...
        for required in [
            ...
            "**/.config/gh/**", "**/.config/councis/**", "**/.git/config",
            ".councis-rag-store.json", ".councis-rag-snapshots",
            ".councis-rag-host",
        ] {
            XCTAssertTrue(
