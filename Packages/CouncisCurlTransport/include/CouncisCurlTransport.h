#ifndef COUNCIS_CURL_TRANSPORT_H
#define COUNCIS_CURL_TRANSPORT_H
...
typedef size_t (*councis_curl_data_callback)(
    const uint8_t *bytes,
    size_t length,
    void *context);

typedef int32_t (*councis_curl_cancel_callback)(void *context);
