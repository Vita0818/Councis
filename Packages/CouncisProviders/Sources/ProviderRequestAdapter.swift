...
///
/// Councis remains Swift-native and does not execute npm packages. The package
    ...
    Sendable
{
    ...
    public static let siliconFlowV1 = ProviderRequestAdapter(
        rawValue: "councis:siliconflow-v1")
    ...
    public static let cohereV2 = ProviderRequestAdapter(
        rawValue: "councis:cohere-v2")

    /// Missing adapter fields in previously persisted Councis values decode to
    ...
    public static let legacyOpenAIWire = ProviderRequestAdapter(
        rawValue: "councis:legacy-openai-wire")
    ...
    public init(rawValue: String) {
        ...
        case "intatis:siliconflow-v1":
            self.rawValue = "councis:siliconflow-v1"
            return
        case "intatis:cohere-v2":
            self.rawValue = "councis:cohere-v2"
            return
        case "intatis:legacy-openai-wire":
            self.rawValue = "councis:legacy-openai-wire"
            return
        default:
            break
        }
