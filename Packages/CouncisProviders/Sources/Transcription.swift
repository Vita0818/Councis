...
// OpenAICompatibleTranscriber pipeline. Councis keeps only the single-model
...
private enum TranscriptionTemporaryFiles {
    static let inputPrefix = "Councis-Transcription-Input-"
    static let bodyPrefix = "Councis-Transcription-Body-"
...
private struct TranscriptionBodyFile {
    ...
    static func multipart(
        ...
        let boundary = "CouncisBoundary-\(UUID().uuidString)"
