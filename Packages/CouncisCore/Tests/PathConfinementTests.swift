...
final class PathConfinementTests: XCTestCase {
    ...
    private func tempWorkspace() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("councis-path-\(UUID().uuidString)", isDirectory: true)
    ...
    func testAgentConfigSecretPathsDenied() throws {
        ...
        XCTAssertThrowsError(try PathConfinement.resolve("~/.config/councis/config.json", within: root))
