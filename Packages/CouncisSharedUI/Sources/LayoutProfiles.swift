...
public struct CouncisSplitColumnLayout: Equatable {
    ...
    public static let chatInspector = CouncisSplitColumnLayout(
        sidebarMin: 160,
        sidebarIdeal: 210,
        contentMin: 300,
        contentIdeal: 560,
    ...
    public static let workspace = CouncisSplitColumnLayout(
        sidebarMin: 150,
        sidebarIdeal: 200,
        contentMin: 320,
        contentIdeal: 600,
...
public struct CouncisWorkspaceInspectorLayout: Equatable {
...
public enum CouncisWorkspaceInspectorLayoutPolicy {
    public static func resolve(
        ...
        guard isRequested,
            ...
            return CouncisWorkspaceInspectorLayout(
                isVisible: false,
...
public enum CouncisCoworkStatusRailLayoutPolicy {
...
public struct ThreeColumnShellLayout: Equatable {
    ...
    public var columns: CouncisSplitColumnLayout

    public init(presentation: Presentation = .split,
                columns: CouncisSplitColumnLayout = .chatInspector) {
