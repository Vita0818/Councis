...
public final class ChatViewModel: ObservableObject {
    ...
    @Published public private(set) var draftAttachments: [CouncisComposerDraftAttachment] = []
    ...
    public init(
        ...
        self.composerAttachmentStore = artifactStore.map {
            CouncisComposerAttachmentStore(store: $0)
        }
        #if canImport(AVFoundation)
        ...
        let operation = Task { @MainActor [weak self] in
            ...
            for url in urls {
                ...
                do {
                    ...
                    guard !CouncisCancellation.isCurrentTaskCancellation(error) else {
                        return
                    }
                    self.errorText = CouncisLocalization.format(
    ...
    public func generateImage() {
        ...
        guard let onGenerateImage else {
            let message = CouncisLocalization.string("Image generation is not available.")
