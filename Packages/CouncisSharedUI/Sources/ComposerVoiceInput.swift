...
// part of the Councis composer integration.
...
private enum ComposerVoiceTemporaryFiles {
    static let audioPrefix = "Councis-Audio-"
    private static let legacyAudioPrefix = "councis-voice-input-"
...
public final class ComposerVoiceInputController: ObservableObject {
    ...
    public var buttonHelp: String {
        switch phase {
        case .idle:
            return CouncisLocalization.string("Start voice input")
        case .requestingPermission:
            return CouncisLocalization.string("Preparing voice input")
        case .recording:
            return CouncisLocalization.string("Stop and transcribe")
        case .transcribing:
            return CouncisLocalization.string("Transcribing voice input")
        }
    }
    ...
    private func publish(_ error: Error) {
        ...
        case ComposerVoiceInputFailure
                .transcriptionModelNotConfigured:
            errorText = CouncisLocalization.string(
        ...
        case ComposerVoiceInputFailure.microphoneBusy,
            ...
            errorText = CouncisLocalization.string(
                "The microphone is already being used by another Councis session.")
        ...
        default:
            errorText = CouncisLocalization.format(
                "Voice input failed: %@",
