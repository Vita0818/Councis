...
/// Councis-native, snapshot-bound RAG entry point. Paths, provider identities,
...
public struct SearchKnowledgeTool: Tool {
    ...
    public static func registryVersionComponent(
        ...
        return try KnowledgeDigest.canonical(Projection(
            version: "councis-search-knowledge-registration/1",
            ...
            groundingRevalidationVersion:
                "councis-final-grounding-revalidation/1"))
    }
...
struct KnowledgeSearchToolSchemas: Sendable {
    ...
    static func load(
        ...
        if boundToSingleKnowledgeBase {
            ...
            root["$id"] = .string(
                "https://schemas.councis.local/knowledge/search-knowledge-bound-input-v2.schema.json")
            root["title"] = .string(
                "Councis snapshot-bound search_knowledge input v2")
            input = .object(root)
        }
