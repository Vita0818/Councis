...
import Crypto
#else
#error("CouncisKnowledge requires CryptoKit or swift-crypto")
#endif
import CouncisCore
...
public enum KnowledgeContract {
    ...
    public static let profileSchema = "councis-okf-rag-profile/0.1"
    public static let profileIdentity = "org.vita.councis.okf-rag"
    public static let profileVersion = "0.1"
    public static let storeSchema = "councis-rag-store/1"
    public static let chunkSchema = "councis-chunk/1"
    public static let checksumsSchema = "councis-rag-checksums/1"
    public static let validationSchema = "councis-rag-validation/1"
    public static let evidenceContract = "councis-evidence/1"
    public static let validatorIdentity = "org.vita.councis.knowledge-validator"
    public static let validatorVersion = "1"
    public static let textNormalizationVersion = "councis-text-normalization/1"
    public static let deterministicChunkerIdentity = "org.vita.councis.heading-paragraph-window"
    public static let deterministicChunkerVersion = "1"
    public static let exactKNNBackendIdentity = "org.vita.councis.exact-knn"
    public static let exactKNNFormatVersion = "float32-json/1"
    public static let exactKNNRuntimeVersion = "1"
    public static let lexicalBackendIdentity = "org.vita.councis.bm25"
    ...
    public static let utf8SourceLocatorAdapterIdentity =
        "org.vita.councis.utf8-byte-range"
...
public struct KnowledgeSourceLocator: Codable, Equatable, Hashable, Sendable {
    ...
    public init(schema: String = "councis-source-locator/1",
                sourceID: String,
...
public struct KnowledgeDenseIndexFile: Codable, Equatable, Sendable {
    ...
    public init(dimensions: Int, vectors: [KnowledgeDenseVectorRecord]) {
        schema = "councis-dense-exact-knn/1"
        self.dimensions = dimensions
