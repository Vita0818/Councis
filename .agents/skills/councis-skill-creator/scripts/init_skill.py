#!/usr/bin/env python3
"""Create an Councis Agent Skill skeleton inside an explicitly selected root.

Modified by Councis from the OpenAI Codex skill-creator sample; see
...
def main():
    parser = argparse.ArgumentParser(
        description="Create an Councis Agent Skill skeleton."
    )
