...
It is a developer verification fixture only. It is not linked into Councis,
...
Run from the Councis repository root:

```sh
CARGO_TARGET_DIR=/private/tmp/councis-mcp-bm25-oracle-target \
cargo fetch --locked \
...
`Packages/CouncisMCP/Tests/MCPBM25CodexParityTests.swift`:
