...
- **Fixed Cowork role model routes**：macOS 与 modern CLI 只读取 canonical 顶层
  ...
  JSON 文档已经解析出的顶层 `model`，不读取 `INTATIS_MODEL`、UserDefaults/UI selection、Cowork
