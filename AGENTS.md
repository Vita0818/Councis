...
4. `docs/MACOS_DISTRIBUTION.md`
5. `docs/PROJECT_MAP.md`
6. `docs/ARCHITECTURE.md`
7. `docs/DO_NOT_BREAK.md`
8. `docs/OPEN_SOURCE_REUSE.md`
9. `docs/TESTING.md`
10. `docs/NEXT_TARGET.md`（如果存在）
11. `docs/COWORK_PRINCIPLES.md`（修改 Cowork / AgentKernel / MessageBus / 权限 / agent 编排前必读）
