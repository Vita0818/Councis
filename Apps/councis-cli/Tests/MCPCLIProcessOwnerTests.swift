    ...
    XCTestCase
{
        ...
        throws
    {
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "councis-cli-shipping-stdout-\(UUID().uuidString)",
                isDirectory: true)
        ...
        environment["COUNCIS_CONFIG"] =
            configURL.path
        environment["COUNCIS_API_KEY"] =
            "shipping-cli-test-key"
        environment["COUNCIS_MODEL"] =
        ...
        XCTAssertTrue(stdout.contains("Councis"))
        ...
        async throws
    {
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "councis-cli-mcp-owner-\(UUID().uuidString)",
                isDirectory: true)
        let workspace = root.appendingPathComponent(
            "workspace",
            isDirectory: true)
    ...
    private static func makeHostFixture(
        ...
        let root = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "councis-cli-host-\(name)-\(UUID().uuidString)",
                isDirectory: true)
        let workspace = root.appendingPathComponent(
            "workspace",
            isDirectory: true)
        ...
        throws -> URL
    {
        ...
        throw XCTSkip(
            "The built shipping councis executable is unavailable.")
    }
}
...
private final class MCPCLILoopbackFixture {
    ...
    init() throws {
        statsURL = FileManager.default
            .temporaryDirectory
            .appendingPathComponent(
                "councis-cli-mcp-stats-\(UUID().uuidString).log")
