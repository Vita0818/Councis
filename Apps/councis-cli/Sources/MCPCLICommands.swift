...
enum MCPCLIError:
    ...
    var errorDescription: String? {
        switch self {
        case .missingSubcommand:
            return "missing MCP subcommand; run `councis mcp help`"
...
func printMCPHelp() {
    out("""
    Councis external MCP client

    INVENTORY
      councis mcp list [--json]
      councis mcp get --server <alias|id> [--json]
      councis mcp add --alias <id> --name <name> (--url <https> | --command </absolute/path>) [configuration options] [--yes] [--json]
      councis mcp edit --server <alias|id> [same mutable fields]
      councis mcp duplicate --server <alias|id> --alias <new>
      councis mcp enable|disable --server <alias|id>
      councis mcp remove --server <alias|id> --yes
      councis mcp test --server <alias|id>
      councis mcp doctor [--json]
      councis mcp import --file <explicit.json> [--format mcp-json|claude-json] [explicit launch-closure flags] [--replace-conflicts] [--allow-insecure-loopback-development-http]
      councis mcp export [--file <path>] [--include-disabled]
    ...
    SESSION AUTHORITY
      ...
      councis mcp auth logout --server <alias|id> [--yes]

    LIVE SESSION OWNER
      councis mcp status [--session <id>] [--agent <id>] [--json]
      councis mcp connect --session <id> --agent <id> [--task <id>] [--server <alias|id>] --yes
      councis mcp inspect|tools|resources|prompts --session <id> --agent <id> [--task <id>] [--server <alias|id>] --yes
      councis mcp refresh|disconnect --session <id> --agent <id> [--task <id>] [--server <alias|id>]
      councis mcp reload [--json]
