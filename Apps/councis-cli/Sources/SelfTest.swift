...
func runSelfTest() async throws {
    ...
    let profileDirectory = FileManager.default.temporaryDirectory
        .appendingPathComponent("councis-profile-selftest-\(UUID().uuidString)", isDirectory: true)
    try FileManager.default.createDirectory(at: profileDirectory, withIntermediateDirectories: true)
    let catalogURL = profileDirectory.appendingPathComponent("catalog.json")
    let configURL = profileDirectory.appendingPathComponent("councis.json")
    ...
    uniqueUnqualifiedEnvironment["COUNCIS_MODEL"] = "model-beta"
    uniqueUnqualifiedEnvironment["COUNCIS_REASONING"] = "high"
    ...
    slashModelEnvironment.removeValue(forKey: "COUNCIS_REASONING")
    slashModelEnvironment["COUNCIS_MODEL"] = "anthropic/claude-sonnet"
    ...
    slashTopLevelEnvironment.removeValue(forKey: "COUNCIS_REASONING")
    ...
    unavailableReasoningEnvironment["COUNCIS_MODEL"] = "route-a/model-alpha"
    unavailableReasoningEnvironment["COUNCIS_REASONING"] = "minimal"
    ...
    invalidReasoningEnvironment["COUNCIS_REASONING"] = "not-a-reasoning-effort"
    ...
    secondEnvironment["COUNCIS_REASONING"] = "high"
