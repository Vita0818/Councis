...
struct CouncisMCPSettingsView: View {
    ...
    private func exportCatalog() {
        ...
        CouncisMacProcessDiagnostics.shared
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            case (.macDeveloperID, .stdio),
                ...
                guidanceStep(
                    1,
                    "Install the MCP server using its trusted publisher's instructions outside Councis.")
                guidanceStep(
                    2,
            ...
            case (.linuxCLI, .stdio):
                ...
                guidanceStep(
                    2,
                    "Run councis mcp doctor and resolve every bwrap or launch-artifact error.")
                guidanceStep(
                    3,
