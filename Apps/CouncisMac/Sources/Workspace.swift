...
enum WorkspaceAccess {
    ...
    private static let bookmarkStoreKey =
        LegacyIntatisCompatibility.UserDefaultsKey.workspaceBookmarks

    private static func sessionBookmarkKey(_ session: SessionID) -> String {
        LegacyIntatisCompatibility.UserDefaultsKey
            .workspaceSessionBookmarkPrefix + session.rawValue
    }

    private static func sessionPathKey(_ session: SessionID) -> String {
        LegacyIntatisCompatibility.UserDefaultsKey
            .workspaceSessionPathPrefix + session.rawValue
    }
