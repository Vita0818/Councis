...
/// inference catalog owned by CouncisProviders.
///
...
enum AppInferenceCatalogCompiler {
    ...
    static func profileID(providerID: String,
        ...
        let digest = tupleDigest([
            "councis.app-inference-profile.v1",
            providerID,
            modelID,
            variantID ?? "",
        ])
    ...
    static func connectionID(providerID: String) -> InferenceConnectionID {
        let digest = tupleDigest([
            "councis.app-inference-connection.v1",
            providerID,
        ])
    ...
    static func durableVariantID(providerID: String,
        ...
        let digest = tupleDigest([
            "councis.app-inference-variant.v1",
            providerID,
            modelID,
            variantID,
        ])
    ...
    static func trustDomain(providerID: String,
        ...
        let digest = tupleDigest([
            "councis.app-inference-trust-domain.v1",
            providerID,
