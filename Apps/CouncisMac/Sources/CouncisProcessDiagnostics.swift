...
@MainActor
final class CouncisMacProcessDiagnostics {
    static let shared = CouncisMacProcessDiagnostics()
    ...
    private let driver: CouncisMainThreadHeartbeatDriver
    ...
    private init() {
        ...
        driver = CouncisMainThreadHeartbeatDriver(
            store: store,
            applicationVersion:
                Bundle.main.object(
...
private final class CouncisMainThreadHeartbeatDriver: @unchecked Sendable {
