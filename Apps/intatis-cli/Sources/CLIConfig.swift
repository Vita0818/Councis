...
/// Persistent config at `~/.councis/config.json` (all values are strings).
...
struct CLIConfig {
    ...
    static func load(requireAPIKey: Bool = true) throws -> CLIConfig {
        ...
        func value(_ envKey: String, _ legacyEnvKey: String?, _ fileKey: String, fallback: String?) -> String? {
        ...
        let baseString = value("COUNCIS_BASE_URL", "INTATIS_BASE_URL", "baseURL", fallback: defaultBaseURL)!
