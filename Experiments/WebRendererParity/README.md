...
- it has no bridge to Councis sessions, EventLog, credentials, tools, leases,
  or permissions.
...
```sh
cd /Users/vita/Vitemis/Councis/Experiments/WebRendererParity
npm ci
npm test
npm run licenses
npm run build
...
message contents, parser instances, browser state, credentials, or Councis
data.
