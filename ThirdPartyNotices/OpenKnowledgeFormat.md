...
Councis adopts a byte-exact copy of the self-contained Open Knowledge Format
...
- Councis-authored provenance and checksum records.
...
Councis' OKF RAG Profile, validator, snapshot store, indexes, and tool
