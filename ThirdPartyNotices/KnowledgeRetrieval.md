...
Councis uses Yams only inside the `CouncisKnowledge` target to parse
...
MIT licensed. Councis does not copy Yams source into this repository; SwiftPM
...
Councis applies its own pre-parse byte limits, rejects aliases and custom tags,
